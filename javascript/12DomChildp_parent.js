...
let yogi=document.getElementsByClassName("boxx");
console.log(yogi);

yogi[2].style.backgroundColor="red";

let yogi25=document.getElementById("red");
yogi25.style.backgroundColor="yellow"

let yoggi3=document.querySelector(".boxx");
yoggi3.style.backgroundColor="green"
